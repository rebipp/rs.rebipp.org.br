...
root.title("REBIPP RDF database dumper")
...
dumpUriBox.insert(END, 'http://rs.rebipp.org.br/dump/')
...
graphNameBox.insert(END, 'http://rs.rebipp.org.br/')

def baseToTripleButtonClick():
    csvData = getCsvObject('https://raw.githubusercontent.com/rebipp/rs.rebipp.org/master/index/', 'index-datasets.csv', ',')
    loadList = []
    for row in csvData:
